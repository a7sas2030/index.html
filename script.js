...
function updateTable(market) {
    ...
    data.forEach((entry, index) => {
        ...
        const formattedProfit = market === 'Saudi' ? 
            profit.toLocaleString('ar-SA', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + ' ريال' :
            '$' + profit.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
            
        const formattedRunningTotal = market === 'Saudi' ?
            runningTotal.toLocaleString('ar-SA', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + ' ريال' :
...
function calculateTotal(market) {
    ...
    const formattedTotal = market === 'Saudi' ?
        total.toLocaleString('ar-SA', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + ' ريال' :
